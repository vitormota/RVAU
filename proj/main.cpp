...
{
public:
	CameraSettings() : goodInput(false) {}
...
bool runCalibrationAndSave(CameraSettings& s, Size imageSize, Mat&  cameraMatrix, Mat& distCoeffs, vector<vector<Point2f> > imagePoints)
{
